export default function Header() {
  return (
    <>
      <header className="flex w-dvw min-h-12 text-blue-950 bg-transparent items-center justify-center">
        {/* Keyboard icons in the header */}
        <svg
          width="36px"
          height="36px"
          viewBox="0 0 24 24"
        ...
        <h2 className="text-4xl font-semibold">Celestial Scribes</h2>
      </header>
    </>
  );
}
