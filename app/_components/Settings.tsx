...
export default function Settings({onChange}:{onChange:ChangeEventHandler<HTMLInputElement>}) {
  return (
    <div className="flex justify-center w-screen h-fit gap-8 items-center">
      <label>
        <svg
          width="36px"
          height="36px"
        ...
        <input
          type="checkbox"
          defaultChecked
          className="toggle border-blue-950 bg-blue-950 checked:text-orange-400"
          onChange={onChange}
        />
      </label>
      {/* <label>
        <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="-4 -4 24 24" width="36px" height="36px">
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
        ...
        <input
          type="checkbox"
          defaultChecked
          className="toggle border-blue-950 bg-blue-950 checked:text-green-400"
        />
      </label> */}
      {/* <label>
        <input
