    ...
    return (
        <>
            ...
            <div className="bg-transparent w-11/13 flex h-1/2 relative top-20">
                <div className="bg-transparent w-1/7 h-full flex flex-col text-center justify-center items-center text-base-content gap-1">
                    <div className="text-2xl text-secondary">WPM</div>
                    <div className="text-5xl text-base-content">{latest.wpm}</div>
                    <div className="text-2xl text-secondary">Accuracy</div>
                    <div className="text-5xl text-base-content">{`${accuracy}%`}</div>
                    <div className="text-xl text-secondary">test type</div>
            ...
            <div className="bg-transparent w-11/13 h-1/8 flex relative top-20 justify-center items-center gap-20 text-base-content">
                ...
                <div onClick={screenshotAndCopy} className="tooltip tooltip-bottom" data-tip="Copy screenshot to clipboard">
                    <svg width="40px" height="40px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M8.5 13.5L8.5 18.5M8.5 18.5L10.5 16.625M8.5 18.5L6.5 16.625" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                </div>
