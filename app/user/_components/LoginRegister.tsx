        ...
        <div id="register" className="h-32">
          <form onSubmit={handleSubmit(onSubmit)}>
            <fieldset className="fieldset bg-currentColor border-base-300 rounded-box w-xs border p-4">
              ...
              <label className="label text-blue-950">Verify Email</label>
              <input
                {...register("verifyEmail", {
                  required: "Confirm your email address",
                  validate: (value) => value === getValues("email") || "Email address must match"
                })}
                type="email"
                className="input bg-white"
                ...
                id="verifyEmail"
              />
              {errors.verifyEmail && ErrorMessage(`${errors.verifyEmail.message}`)}
              ...
              <label className="label text-blue-950">Verify Password</label>
              <input
                ...
                id="verifyPassword"
              />
              {errors.verifyPassword && ErrorMessage(`${errors.verifyPassword.message}`)}
              <button className="btn btn-neutral mt-4" disabled={isSubmitting}>Sign up</button>
            </fieldset>
          </form>
        </div>
        <div id="login" className="h-32">
          <form>
            <fieldset className="fieldset bg-currentColor border-base-300 rounded-box w-xs border p-4">
              ...
              <label className="label text-blue-950"></label>
